    ...
    <div class="container-fluid breadcrumb-wrapper">
        <div class="row h-100 align-items-center">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h1 class="fs-20 fs-md-24" style="color: #B62025">
                            @if(isset($detailedProduct->main_category))
                                {{ $detailedProduct->main_category->getTranslation('name') }} / {{$detailedProduct->getTranslation('name')}}
                            @else
