<script>
    ...
    */
    ...
    function storeTempdata(e) {
        ...
        var tempData = localStorage.getItem('tempdataproduct');
        if(tempData == null){
            tempData = '{}';
        }
        ...
        localStorage.setItem('tempdataproduct', updatedData);
        localStorage.setItem('tempload', 'yes');
    }
    ...
    */
    ...
    $(document).ready(function(){
        var tempload = localStorage.getItem('tempload');
        var tags_defined = 'no';
        if(tempload == 'yes'){
            var tempData = localStorage.getItem('tempdataproduct');
            var obj = JSON.parse(tempData);
